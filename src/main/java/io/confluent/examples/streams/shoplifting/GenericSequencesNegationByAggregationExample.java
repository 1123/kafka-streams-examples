...
public class GenericSequencesNegationByAggregationExample {
  ...
  public static Properties  streamsConfiguration() {
    ...
    streamsConfiguration.put(StreamsConfig.APPLICATION_ID_CONFIG, "GenericSequencesNegationByAggregationExampleApp");
    streamsConfiguration.put(StreamsConfig.CLIENT_ID_CONFIG, "GenericSequencesNegationByAggregationExampleClient");
